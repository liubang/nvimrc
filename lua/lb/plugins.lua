...
packer.startup {
  function(use)
    ...
    use {
      'mhinz/vim-startify',
      config = require("lb.config.vim-startify")
    }
    use {
    ...
    use {
      ...
      config = require("lb.config.vim-cursorword")
    }
    ...
    use {
      ...
      cmd = {
        'FloatermNew', 'FloatermToggle', 'FloatermPrev', 
        'FloatermNext', 'FloatermSend', 'FloatermKill'
      },
    ...
    use {
      ...
      config = require("lb.config.vista")
    }
    use {
    ...
    use {
      'neoclide/coc.nvim',
      branch = 'release',
      config = require("lb.config.coc").on_attach()
    }
    ...
    use {
      ...
      ft = 'markdown',
      config = require("lb.config.vim-markdown")
    }
    use {
      'iamcco/markdown-preview.nvim',
      ft = {
        'markdown', 'pandoc.markdown', 'rmd'
      },
    ...
    use {
      'z0mbix/vim-shfmt',
      ft = 'sh',
      config = require("lb.config.vim-shfmt")
    }
    use {
