...
function! health#nvim_config#check()
  ...
  call s:check_executable('shfmt', 'shfmt', ['Run in shell: go install mvdan.cc/sh/v3/cmd/shfmt'])
  call s:check_executable('asmfmt', 'asmfmt', ['Run in shell: go install github.com/klauspost/asmfmt/cmd/asmfmt@latest'])
  call s:check_executable('buildifier', 'buildifier', ['Run in shell: go install github.com/bazelbuild/buildtools/buildifier'])
